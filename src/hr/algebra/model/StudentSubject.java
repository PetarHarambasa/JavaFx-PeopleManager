...
import static hr.algebra.dao.sql.HibernateFactory.SELECT_STUDENTSSUBJETS;
...
@XmlRootElement
@NamedQueries({
    @NamedQuery(name = SELECT_STUDENTSSUBJETS, query = "SELECT s FROM StudentSubject s")})
public class StudentSubject implements Serializable {
    ...
    public StudentSubject(Integer iDStudentSubject, Student studentID, Subject subjectID) {
        this.iDStudentSubject = iDStudentSubject;
    ...
    public StudentSubject(StudentSubject data){
        updateDetails(data);
    }

    public void updateDetails(StudentSubject data) {
